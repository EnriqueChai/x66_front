    ...
    <div class="list-content">
      ...
      <div class="recomLsitMid">
        ...
        <div class="paper-meta">
          ...
          <span class="meta-item">
            <i class="el-icon-reading"></i> 引用: {{ paper.citations !== undefined && paper.citations !== null ?
              paper.citations : 0 }}
          </span>
          <div class="theme-tags">
            <template v-if="paper.themes && paper.themes.length > 0">
              <el-tag v-for="(theme, i) in paper.themes" :key="i" size="mini" effect="plain" type="info"
                class="theme-tag">
                {{ theme }}
              </el-tag>
            </template>
